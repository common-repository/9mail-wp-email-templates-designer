...
Tags:  email, email template, email customizer
Requires PHP: 7.0
...
> [Try the Demo](https://new2new.com/?item=9mail "Demo 9MAIL – WordPress Email Templates Designer") | [Documents](https://docs.villatheme.com/9mail-wordpress-email-templates-designer/ "Documents") | [Pro Version](https://1.envato.market/kj3VaN "Pro Version") | [Facebook group](https://www.facebook.com/groups/villatheme "VillaTheme")

[youtube https://www.youtube.com/watch?v=4NMQaLrdnCw]

###Features of WordPress Email Templates Designer
- Easily drag and drop elements to build and customize emails with 9MAIL – WP Email Templates Designer: – The easy-to-use email template builder allows you to create professional and eye-catching WordPress email templates.
- Layout: Layouts can be added quickly by dragging and dropping appropriate layouts, available from 1 -4 columns.
- Elements – Add different elements to your email template with sufficient information of WordPress emails. The editing tab will show allow you to work directly on fast and effectively each element.
- Unlimited Number of Rows – unlimited rows can be added to the email template and include everything you need in the emails.
- Direction: Support email texts right to left text and reverse.
...
- Default template: If you are using a 3rd plugin, and the email contents of this 3rd plugin is not attached in WordPress default emails, but they create their own email templates.  In this case, you can use the default template type.


###Additional features in WordPress Email Templates Designer
- Unlimited templates: You can Add new to create as many templates as you want. The created email templates will be stored in the email template list page where you can easily edit, quick edit, trash, bulk action, filter templates.
- Export and import data to among templates. In some case, the export and import data will save your time to move a template setting  to another template to keep using the style without rebuilding.
- Custom CSS:  Add custom CSS to design the templates as you want.
...
&#9658; [Getting Started](https://docs.villatheme.com/?item=9mail-wp-email-templates-designer)

### Plugin Links

&#9658; [Project Page](https://villatheme.com)
&#9658; [Documentation](https://docs.villatheme.com/?item=9mail-wp-email-templates-designer)
&#9658; [Report Bugs/Issues](https://villatheme.com/supports)

== Installation ==

1. Unzip the download package
1. Upload `9mail-wp-email-templates-designer` to the `/wp-content/plugins/` directory
...
== Changelog ==
/**1.0.14 - 2024.10.18**/
- Updated: Change shortcode {{ignore_9mail}} to ignore_9mail
– Updated: Update support class

/**1.0.13 - 2024.04.17**/
- Update: Compatible with WordPress 6.5
- Update: Support file
...
/**1.0.10 - 2023.02.22**/
- Fix: Fix some string text domain

/**1.0.9 - 2022.08.31**/
- Fix: Check pro version exist

/**1.0.8 - 2022.08.18**/
- Update: Change namespace
- Update: Premium version URL

/**1.0.7 - 2022.07.02**/
- Fix: Save Hebrew characters
...
/**1.0.4 - 2022.04.18**/
- Fix: Exclude WooCommerce HTML email

/**1.0.3 - 2022.04.15**/
- Fix: Link of menu bar

/**1.0.2 - 2022.04.08**/
- Update: Zoho mail layout

/**1.0.1 - 2022.04.04**/
- Update: Delete element, row by press keyboard
